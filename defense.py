...
from densenet import densenet121,densenet161   #还可以调用其他的例如169，201等
...
def train_cnn_model(model_name, gpu_ids, batch_size):
    ...
    dataset_dir = '/Volumes/LJY/IJCAI/IJCAI_2019_AAAC_train/IJCAI_2019_AAAC_train-4'

    img_size = model.input_size[0]
    loaders = load_data_for_training_cnn(dataset_dir, img_size,  batch_size=batch_size*len(gpu_ids))

    # Prepare training options
    save_path = '/Users/emperor/Desktop/defense/%s' %model_name
