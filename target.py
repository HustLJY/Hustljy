...
# 声明一些攻击参数
CHECKPOINTS_DIR = '/Volumes/LJY/IJCAI'
...
output = ''
max_epsilon = 32.0
num_iter = 20        #迭代次数，据说15次最好？
batch_size = 11      #同时进行11个？
momentum = 1.0       #动量优化方法，深度学习优化方法的一种，还有momentum、Nesterov Momentum、AdaGrad、Adadelta、RMSprop、Adam等
...
if __name__ == '__main__':
    input_dir = '/Volumes/LJY/IJCAI/dev_data'
    output_dir = '/Users/emperor/Desktop/target'
